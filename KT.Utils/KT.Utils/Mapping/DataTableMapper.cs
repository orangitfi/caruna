...
namespace KT.Utils.Mapping
{
    public class DataTableMapper
    {
        ...
        public static DataTable EntitiesToDataTable<T>(IEnumerable<T> entities, IEnumerable<DataColumnMapping<T>> columnMappings, bool hascaptions = false)
        {
            ...
            {
                DataColumn column = new DataColumn(mapping.ColumnName, mapping.DataType);
                if (hascaptions) column.Caption = mapping.Description;
