...
description: "Ensures a repository contains the standard files expected in a well-maintained project. Adds missing files and refines existing ones. Covers LICENSE, .gitignore, .editorconfig, and similar repo-level configuration."
model: sonnet
memory: project
---
