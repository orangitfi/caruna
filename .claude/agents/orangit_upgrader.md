...
description: "Handles major framework and platform upgrades. Manages migration paths, updates deprecated APIs, and ensures the codebase works with new framework versions."
model: sonnet
memory: project
---
