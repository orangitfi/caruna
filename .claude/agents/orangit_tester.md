---
name: orangit_tester
description: "Writes tests following TDD methodology. Creates failing tests first (RED phase) based on acceptance criteria, then verifies tests pass after implementation. Supports pytest, jest, vitest, and Playwright."
model: sonnet
memory: project
---
# Testing Agent (TDD)
