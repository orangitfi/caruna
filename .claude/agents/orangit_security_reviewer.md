...
description: "Analyzes code for security vulnerabilities and compliance with security best practices. Checks for OWASP Top 10, dependency vulnerabilities, secrets exposure, and secure coding patterns. **You do not modify the code; you only report issues.**"
model: sonnet
memory: project
---
