...
description: "Manages dependency updates for the project. Checks for outdated packages, evaluates update safety, and applies updates while ensuring tests continue to pass."
model: sonnet
memory: project
---
