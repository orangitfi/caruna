...
description: "Reviews code changes for quality, consistency, and best practices. Checks for clean code principles, proper error handling, naming conventions, and adherence to project standards."
model: sonnet
memory: project
---
# Code Review Agent
