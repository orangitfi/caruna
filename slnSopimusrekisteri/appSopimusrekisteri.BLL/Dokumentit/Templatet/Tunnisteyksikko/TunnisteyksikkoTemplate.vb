Public Class TunnisteyksikkoTemplate
  Inherits TemplateEntityBase(Of DTO.Tunnisteyksikko)
  ...
  Protected Overrides Function GetPropertyValue(ByVal key As String, ByVal entity As DTO.Tunnisteyksikko) As String
