...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_PuustonPoisto.OrderBy(Function(x) x.PPOPuustonPoisto)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_PuustonPoisto)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_PuustonPoisto)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.PPOId
        hakutulos.Nimi = muunnettava.PPOPuustonPoisto
        hakutulos.Tyyppi = "Puuston poisto"
        Return hakutulos
