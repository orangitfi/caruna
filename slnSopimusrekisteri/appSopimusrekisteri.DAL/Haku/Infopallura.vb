...
#Region "Hakumetodit"
  ...
  Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
    ...
    Using tietokanta As New Entities.FortumEntities()
      ...
      Dim rivit = tietokanta.hlp_Infopallura.OrderBy(Function(x) x.IFPId)
...
#Region "Konversiometodit"
  ...
  Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Entities.hlp_Infopallura)) As List(Of iHakutulos)
  ...
  Private Function MuutaHakutulokseksi(muunnettava As Entities.hlp_Infopallura)

    Dim hakutulos = New Hakutulos()
    hakutulos.ID = muunnettava.IFPId
    hakutulos.Nimi = muunnettava.IFPLomake & " " & muunnettava.IFPKentta
    hakutulos.Tyyppi = "Infopallura"
    Return hakutulos
