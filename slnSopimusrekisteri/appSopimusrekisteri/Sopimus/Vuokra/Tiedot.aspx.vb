...
Namespace Sopimus.Vuokra
    ...
    Public Class Tiedot
        ...
        Private Sub AsetaNakyvyydet()
            ...
            Korvauslaskelmat1.Visible = (Roles.IsUserInRole(Konfiguraatio.Roolit.KorvauslaskelmaSuppea) Or Roles.IsUserInRole(Konfiguraatio.Roolit.KorvauslaskelmaLaaja))
            ...
            Maksut1.Visible = Roles.IsUserInRole(Konfiguraatio.Roolit.Maksut)
        ...
        Private Sub TaytaKorvauslaskelmat()

            Korvauslaskelmat1.EntityId = Me.EntityId
            Korvauslaskelmat1.ListaaData(Me.Entity.Korvauslaskelmat)

        End Sub

        Private Sub TaytaMaksut()

            Maksut1.SopimusId = Me.EntityId.Value
        ...
        Protected Sub btnKopioi_Click(sender As Object, e As EventArgs) Handles btnKopioi.Click
            ...
            Response.Redirect(String.Format("~/Sopimus/Vuokra/Muokkaa.aspx?kopioId={0}&tyyppi={1}", Me.EntityId.ToString(), CInt(Me.Entity.SopimustyyppiId).ToString()))

        End Sub

        Private Sub ItemDeletedEventHandler() Handles Korvauslaskelmat1.ItemDeleted, Asiakkaat1.ItemDeleted
