...
Namespace Sopimus.Suostumus
    ...
    Public Class Muokkaa
        ...
        Protected Overloads Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                If Me.IsNewEntity Then
                    If Me.Tyyppi = Sopimustyypit.Suostumus And Not Roles.IsUserInRole(Konfiguraatio.Roolit.SopimusLaaja) And Not Roles.IsUserInRole(Konfiguraatio.Roolit.Admin) And Not Roles.IsUserInRole(Konfiguraatio.Roolit.Suostumus) And Not Roles.IsUserInRole(Konfiguraatio.Roolit.MuistioSuullisestaSopimuksesta) Then
        ...
        Private Sub AlustaSivu()
            ...
            WebUtils.DataBindList(Of PuustonOmistajuus)(PuustonOmistajuusId, Me.Handlers.PuustonOmistajuudet.GetAll(), AddressOf UiHelper.LuoListItemPuustonOmistajuus, AddressOf UiHelper.LuoTyhjaListItem)
            WebUtils.DataBindList(Of PuustonPoisto)(PuustonPoistoId, Me.Handlers.PuustonPoistot.GetAll(), AddressOf UiHelper.LuoListItemPuustonPoisto, AddressOf UiHelper.LuoTyhjaListItem)
            ...
            Select Case Me.Tyyppi
                Case Sopimustyypit.MuistioSuullisestaSopimuksesta
                    lblOtsikko.Text = "Muistio suullisesta sopimuksesta tiedot"
                Case Sopimustyypit.CCAPylvaidenLuovutuskirja
                    lblOtsikko.Text = "CCA-pylväiden luovutuskirja"
                Case Else
                    lblOtsikko.Text = "Suostumuksen tiedot"
            End Select
        ...
        Private Sub AsetaOletustiedot()
            ...
            Select Case Me.Tyyppi
                Case Sopimustyypit.MuistioSuullisestaSopimuksesta
                    lblSopimusnro.Text = "Uusi muistio suullisesta sopimuksesta"
                Case Sopimustyypit.CCAPylvaidenLuovutuskirja
                    lblSopimusnro.Text = "Uusi CCA-pylväiden luovutuskirja"
                Case Else
                    lblSopimusnro.Text = "Uusi suostumus"
            End Select
