<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.Sopimus.JAS.Tiedot" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
...
<%@ Register Src="~/Sopimus/Korvauslaskelmat.ascx" TagName="Korvauslaskelmat" TagPrefix="uc" %>
<%@ Register Src="~/Sopimus/Maksut.ascx" TagName="Maksut" TagPrefix="uc" %>
...
<asp:Content ID="ctnContent" ContentPlaceHolderID="cphContent" runat="server">
        ...
        <div class="view2columns">
            <table>
                ...
                <tr>
                    ...
                    <td class="view2columnsContentElement2">
                        <asp:Label ID="Kieli_Nimi" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    ...
                    <td class="view2columnsContentElement2"><asp:Label ID="Erityisehdot" runat="server"></asp:Label></td>
                </tr>
    ...
    <uc:Korvauslaskelmat ID="Korvauslaskelmat1" runat="server" />
    <uc:Maksut ID="Maksut1" runat="server" />
