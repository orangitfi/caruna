<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Muokkaa.aspx.vb" Inherits="appSopimusrekisteri.Sopimus.Lupa.Muokkaa" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
    ...
    <div class="form" id="formData" runat="server">
        ...
        <table class="form">
          ...
          <uc3:Infopallura ID="ifpErityisehdot" runat="server" Kentta="Erityisehdot"></uc3:Infopallura>
            ...
            <tr>
                <td class="formHeader">Lupataho
          <uc3:Infopallura ID="ifpLupatahoId" runat="server" Kentta="LupatahoId"></uc3:Infopallura>
                </td>
                <td class="formValidation"></td>
                <td class="formInputElement">
                    <asp:DropDownList ID="LupatahoId" runat="server" />
                </td>
            </tr>
            <tr>
