...
Namespace Sopimus.Lupa
    ...
    Public Class Muokkaa
        ...
        Private Sub AlustaSivu()
            ...
            WebUtils.DataBindList(Of Lupataho)(LupatahoId, Me.Handlers.Lupatahot.GetAll(), AddressOf UiHelper.LuoListItemLupataho, AddressOf UiHelper.LuoTyhjaListItem)
            ...
            Select Case Me.Tyyppi
                Case Sopimustyypit.Sijoituslupa
                    lblOtsikko.Text = "Sijoitusluvan tiedot"
                Case Sopimustyypit.Rakennuslupa
                    lblOtsikko.Text = "Rakennusluvan tiedot"
                Case Sopimustyypit.Toimenpidelupa
                    lblOtsikko.Text = "Toimenpideluvan tiedot"
                Case Sopimustyypit.Risteilylupa
                    lblOtsikko.Text = "Risteilyluvan tiedot"
            End Select
        ...
        Private Sub AsetaOletustiedot()
            ...
            Select Case Me.Tyyppi
                Case Sopimustyypit.Sijoituslupa
                    lblSopimusnro.Text = "Uusi sijoituslupa"
                Case Sopimustyypit.Rakennuslupa
                    lblSopimusnro.Text = "Uusi rakennuslupa"
                Case Sopimustyypit.Toimenpidelupa
                    lblSopimusnro.Text = "Uusi toimenpidelupa"
                Case Sopimustyypit.Risteilylupa
                    lblSopimusnro.Text = "Uusi risteilylupa"
            End Select
