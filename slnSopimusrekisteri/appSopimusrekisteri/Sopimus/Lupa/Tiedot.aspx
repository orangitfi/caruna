<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.Sopimus.Lupa.Tiedot" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
    ...
    <div id="formData" runat="server">
        ...
        <div class="view2columns">
            <table>
                ...
                <tr>
                    <td class="view2columnsHeader1">Korvaa sopimuksen</td>
                    <td class="view2columnsContentElement1">
                ...
                <tr>
                    <td class="view2columnsHeader1">Erityisehdot</td>
                    <td class="view2columnsContentElement1">
                        <asp:Label ID="Erityisehdot" runat="server"></asp:Label></td>
                    <td class="view2columnsHeader2">Lupataho</td>
                    <td class="view2columnsContentElement2">
                        <asp:Label ID="Lupataho_Nimi" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="view2columnsContentElement1">
                        <asp:Label ID="SopimuksenIrtisanomistoimet" runat="server"></asp:Label>
                    </td>
                    <td class="view2columnsHeader2"></td>
                    <td class="view2columnsContentElement2">
                        </td>
