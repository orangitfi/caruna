<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="Muokkaa.aspx.vb" Inherits="appSopimusrekisteri.KirjanpidonKustannuspaikanMuokkaus" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
...
<asp:Content ID="ctnContent" ContentPlaceHolderID="cphContent" runat="server">
  ...
  <h1>Kirjanpidon kustannuspaikan tiedot</h1>
  <div class="form">
    ...
    <table class="form">
      ...
      <tr>
        <td class="formHeader">Selite</td>
        <td class="formValidation">&nbsp;
        </td>
        <td class="formInputElement">
          <asp:TextBox ID="txtSelite" runat="server" Text='' MaxLength="300"></asp:TextBox>
        </td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
