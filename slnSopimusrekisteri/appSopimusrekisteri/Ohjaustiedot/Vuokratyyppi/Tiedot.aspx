<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.VuokratyypinTiedot" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
...
<asp:Content ID="ctnContent" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div class="bar">
        <asp:Button Text='Lisää' CausesValidation='False' ID='btnLisaa' runat='server' PostBackUrl="~/Ohjaustiedot/Vuokratyyppi/Muokkaa.aspx"></asp:Button>
        <div class="barInfo">
    ...
    <div class="list">
        <table class="listGridview" cellpadding="3" cellspacing="0">
            ...
            <tbody>
                <asp:ListView runat="server" ID="lstTulokset" ItemType="Sopimusrekisteri.BLL_CF.Vuokratyyppi" DataKeyNames="Id" OnItemEditing="lstTulokset_ItemEditing" OnItemDeleting="lstTulokset_ItemDeleting">
                    <ItemTemplate>
