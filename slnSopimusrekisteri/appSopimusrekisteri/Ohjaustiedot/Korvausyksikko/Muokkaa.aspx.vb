Public Class YksikonMuokkaus
    ...
    Private Sub TaytaMuokkaustiedot(muokattava As Entities.hlp_Yksikko)
        ...
        lblPaivitetty.Text = PalautaTasmallinenPaivays(muokattava.YKSPaivitetty)
        lblPaivittaja.Text = muokattava.YKSPaivittaja
        lblLuotu.Text = PalautaTasmallinenPaivays(muokattava.YKSLuotu)
        ...
        If Page.IsValid() Then
            ...
            If IsNumeric(Request.Params("id")) Then
                ...
                If Not tallennettava Is Nothing Then
                    Response.Redirect(String.Format("~/Ohjaustiedot/Korvausyksikko/Tiedot.aspx?id={0}", tallennettava.YKSId))
                End If
            Else
    ...
    Protected Sub btPeruuta_Click(sender As Object, e As EventArgs) Handles btPeruuta.Click
        ...
        If IsNumeric(Request.Params("id")) Then
            Response.Redirect(String.Format("~/Ohjaustiedot/Korvausyksikko/Tiedot.aspx?id={0}", Request.Params("id")))
        End If

        Response.Redirect("~/Ohjaustiedot/Korvausyksikko/Tiedot.aspx", True)
