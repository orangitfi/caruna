<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Maksuaineisto_IFS.aspx.vb" Inherits="appSopimusrekisteri.Maksuaineisto_IFS" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
  ...
  <cc1:TabContainer ID="TabAineisto" runat="server" CssClass="tabContainer" ActiveTabIndex="0">
    ...
    <cc1:TabPanel ID="TabVirheellinenAineisto" runat="server" HeaderText="VIRHEELLINEN AINEISTO" Visible="true" Style="overflow-x: scroll;">
      <ContentTemplate>
        ...
        <div class="list">
          ...
          <asp:GridView ID="gvVirheellinenAineisto" runat="server" AutoGenerateColumns="False" HeaderStyle-Wrap="false" RowStyle-Wrap="false" DataKeyNames="SopimusId">

            <Columns>
              <asp:TemplateField HeaderText="Sopimus" ItemStyle-CssClass="listGridviewAction">
                <ItemTemplate>
                  <asp:HyperLink ID="hlSopimus" runat="server" Text='<%# Bind("SopimusId")%>'></asp:HyperLink>
                </ItemTemplate>
              </asp:TemplateField>
    ...
    <cc1:TabPanel ID="TabTarkistettavaAineisto" runat="server" HeaderText="TARKISTETTAVA AINEISTO" Visible="true" Style="overflow-x: scroll;">
      <ContentTemplate>
        ...
        <div class="list">
          <asp:GridView ID="gvTarkistettavaAineisto" runat="server" AutoGenerateColumns="False" DataKeyNames="SopimusId" HeaderStyle-Wrap="false" RowStyle-Wrap="false">
          </asp:GridView>
        </div>
      </ContentTemplate>
    </cc1:TabPanel>
    ...
    <cc1:TabPanel ID="TabMaksettavaAineisto" runat="server" HeaderText="MAKSETTAVA AINEISTO" Visible="true" Style="overflow-x: scroll;">
      <ContentTemplate>
        ...
        <div class="list">
          ...
          <asp:GridView ID="gvMaksettavaAineisto" runat="server" AutoGenerateColumns="False" DataKeyNames="SopimusId" HeaderStyle-Wrap="false" RowStyle-Wrap="false">
