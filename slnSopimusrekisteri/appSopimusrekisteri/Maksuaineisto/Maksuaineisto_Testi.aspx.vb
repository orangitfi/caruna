...
Public Class Maksuaineisto_Testi
  Inherits BasePage2
  ...
  Private Function HaeMaksuaineisto() As Liittymat.Maksuaineisto.Maksuaineisto
    ...
    Dim maksut As IEnumerable(Of Maksu) '= Me.MaksuHander.LuoMaksut(korvauslaskelmat, maksupvm)
  ...
  Protected Sub btnTeeMaksuaineisto_Click(sender As Object, e As EventArgs) Handles btnTeeMaksuaineisto.Click
    ...
    If palaute.Ok Then
      ...
      For Each tiedosto As MaksuaineistoTiedosto In palaute.Tiedostot
        ...
        Try
          File.Copy(tiedosto.Tiedosto, Io.YhdistaKansioJaTiedosto(Konfiguraatiot.MaksuaineistonPolku, tiedosto.KopioTiedosto), False)
