...
Namespace Sopimus.JAS
    ...
    Public Class Muokkaa
        ...
        Private Sub AlustaSivu()
            ...
            Select Case Me.Tyyppi
                Case Sopimustyypit.Yksityistiesopimus
                    lblOtsikko.Text = "Yksityistiesopimuksen tiedot"
                Case Sopimustyypit.Maankayttosopimus
                    lblOtsikko.Text = "Maankäyttösopimuksen tiedot"
                Case Sopimustyypit.Johtoaluesopimus Or Sopimustyypit.JohtoaluesopimusMaakaapeli
                    lblOtsikko.Text = "Johtoaluesopimuksen tiedot"
                Case Else
                    lblOtsikko.Text = "Sopimuksen tiedot"
            End Select
        ...
        Private Sub AsetaOletustiedot()
            ...
            Select Case Me.Tyyppi
                Case Sopimustyypit.Maankayttosopimus
                    lblSopimusnro.Text = "Uusi maankäyttösopimus"
                Case Sopimustyypit.Yksityistiesopimus
                    lblSopimusnro.Text = "Uusi yksityistiesopimus"
                Case Sopimustyypit.Johtoaluesopimus Or Sopimustyypit.JohtoaluesopimusMaakaapeli
                    lblSopimusnro.Text = "Uusi JAS-sopimus"
                Case Else
                    lblSopimusnro.Text = "Uusi sopimus"
            End Select
