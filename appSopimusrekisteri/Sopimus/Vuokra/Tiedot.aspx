<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.Sopimus.Vuokra.Tiedot" Theme="Default" StylesheetTheme="Default" %>
        ...
        <div class="view2columns">
            <table>
                ...
                <tr>
                    ...
                    <td class="view2columnsContentElement2">
                        <asp:Label ID="Erityisehdot" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
