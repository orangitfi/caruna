<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.PuustonOmistajuudenTiedot" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
...
<asp:Content ID="ctnContent" ContentPlaceHolderID="cphContent" runat="server">
  ...
  <div class="bar">
    <asp:Button Text='Lisää' CausesValidation='False' ID='btnLisaa' runat='server' PostBackUrl="~/Ohjaustiedot/PuustonOmistajuus/Muokkaa.aspx"></asp:Button>
    <div class="barInfo">
    ...
    <div class="list">
        ...
        <asp:ObjectDataSource ID="odsTulokset" runat="server"   
            TypeName="appSopimusrekisteri.BLL.PuustonOmistajuus"
            SelectMethod="Hae" 
            InsertMethod="Lisaa"
        ...
        <asp:GridView ID="gwTulokset" DataKeyNames="POMId" runat="server" AutoGenerateColumns="False" DataSourceID="odsTulokset" AllowPaging="True" AllowSorting="True" PageSize="20">
            <Columns>
            <asp:BoundField DataField="POMId" HeaderText="Tunniste" ItemStyle-VerticalAlign="Top" />
            <asp:BoundField DataField="POMPuustonOmistajuus" HeaderText="Nimi" ItemStyle-VerticalAlign="Top" />
            <asp:HyperLinkField Text="Muokkaa" DataNavigateUrlFields="POMId" DataNavigateUrlFormatString="~/Ohjaustiedot/PuustonOmistajuus/Muokkaa.aspx?id={0}" />
