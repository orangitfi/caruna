<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.DFRoolienTiedot" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
...
<asp:Content ID="ctnContent" ContentPlaceHolderID="cphContent" runat="server">
  ...
  <div class="bar">
    <asp:Button Text='Lisää' CausesValidation='False' ID='btnLisaa' runat='server' PostBackUrl="~/Ohjaustiedot/DFRooli/Muokkaa.aspx"></asp:Button>
    <div class="barInfo">
    ...
    <div class="list">
        ...
        <asp:ObjectDataSource ID="odsTulokset" runat="server"   
            TypeName="appSopimusrekisteri.BLL.DFRooli"
            SelectMethod="Hae" 
            InsertMethod="Lisaa"
        ...
        <asp:GridView ID="gwTulokset" DataKeyNames="DFRId" runat="server" AutoGenerateColumns="False" DataSourceID="odsTulokset" AllowPaging="True" AllowSorting="True" PageSize="20">
            <Columns>
            <asp:BoundField DataField="DFRId" HeaderText="Tunniste" ItemStyle-VerticalAlign="Top" />
            <asp:BoundField DataField="DFRRooli" HeaderText="Nimi" ItemStyle-VerticalAlign="Top" />
            <asp:HyperLinkField Text="Muokkaa" DataNavigateUrlFields="DFRId" DataNavigateUrlFormatString="~/Ohjaustiedot/DFRooli/Muokkaa.aspx?id={0}" />
