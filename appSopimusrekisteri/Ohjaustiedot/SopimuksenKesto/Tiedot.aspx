<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="Tiedot.aspx.vb" Inherits="appSopimusrekisteri.SopimuksenKestonTiedot" MasterPageFile="~/Site.Master" Theme="Default" StylesheetTheme="Default" %>
...
<asp:Content ID="ctnContent" ContentPlaceHolderID="cphContent" runat="server">
  ...
  <div class="bar">
    <asp:Button Text='Lisää' CausesValidation='False' ID='btnLisaa' runat='server' PostBackUrl="~/Ohjaustiedot/SopimuksenKesto/Muokkaa.aspx"></asp:Button>
    <div class="barInfo">
    ...
    <div class="list">
        ...
        <asp:ObjectDataSource ID="odsTulokset" runat="server"   
            TypeName="appSopimusrekisteri.BLL.SopimuksenKesto"
            SelectMethod="Hae" 
            InsertMethod="Lisaa"
        ...
        <asp:GridView ID="gwTulokset" DataKeyNames="SKEId" runat="server" AutoGenerateColumns="False" DataSourceID="odsTulokset" AllowPaging="True" AllowSorting="True" PageSize="20">
            <Columns>
            <asp:BoundField DataField="SKEId" HeaderText="Tunniste" ItemStyle-VerticalAlign="Top" />
            <asp:BoundField DataField="SKESopimuksenKesto" HeaderText="Nimi" ItemStyle-VerticalAlign="Top" />
            <asp:HyperLinkField Text="Muokkaa" DataNavigateUrlFields="SKEId" DataNavigateUrlFormatString="~/Ohjaustiedot/SopimuksenKesto/Muokkaa.aspx?id={0}" />
