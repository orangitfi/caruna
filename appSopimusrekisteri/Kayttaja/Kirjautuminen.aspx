            ...
            <table class="form">
              <tr>
                ...
                <td class="formValidation">
                  <asp:RequiredFieldValidator ID="ReqValUsername" runat="server" ControlToValidate="UserName" ErrorMessage="Käyttäjätunnus ei voi olla tyhjä"></asp:RequiredFieldValidator>
                </td>
