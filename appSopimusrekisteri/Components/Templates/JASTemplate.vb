...
Public Class JASTemplate
    ...
    Protected Overrides Function GetPropertyValue(ByVal key As String, ByVal entity As Sopimusrekisteri.BLL_CF.Sopimus) As String
        ...
        Select Case key
            ...
            Case "Projektinumero"
                Return If(String.IsNullOrEmpty(entity.Projektinumero), String.Empty, entity.Projektinumero)
            Case "Projektinvalvoja"
                Return If(String.IsNullOrEmpty(entity.Projektinvalvoja), String.Empty, entity.Projektinvalvoja)
            Case "Karttalehti"
    ...
    Public Overrides Function GetSubEntity(ByVal key As String, ByVal entity As Object) As Object
        ...
        Select Case key
            ...
            Case "MuutLinjaOsat"
                ...
                End If
            Case "Vuokralaiset"
                If sopimus.Asiakkaat.Where(Function(x) x.AsiakastyyppiId.GetValueOrDefault(0) = Asiakastyypit.Vuokralainen).Count() > 0 Then
                    Return sopimus.Asiakkaat.Where(Function(x) x.AsiakastyyppiId.GetValueOrDefault(0) = Asiakastyypit.Vuokralainen).Select(Function(x) x.Taho).ToList()
                Else
                    Return Nothing
                End If
        End Select
