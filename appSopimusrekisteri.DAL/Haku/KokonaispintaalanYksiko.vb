...
Public Class KokonaispintaalanYksikko
...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Yksikko.OrderBy(Function(x) x.YKSKorvausyksikko)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Yksikko)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Yksikko)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.YKSId
        hakutulos.Nimi = muunnettava.YKSKorvausyksikko
        hakutulos.Tyyppi = "Yksikkö"
        Return hakutulos
