...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Saanto.OrderBy(Function(x) x.SAASaanto)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Saanto)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Saanto)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.SAAId
        hakutulos.Nimi = muunnettava.SAASaanto
        hakutulos.Tyyppi = "Sääntö"
        Return hakutulos
