...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_SiirtoOikeus.OrderBy(Function(x) x.SOISiirtoOikeus)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_SiirtoOikeus)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_SiirtoOikeus)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.SOIId
        hakutulos.Nimi = muunnettava.SOISiirtoOikeus
        hakutulos.Tyyppi = "Siirto-oikeus"
        Return hakutulos
