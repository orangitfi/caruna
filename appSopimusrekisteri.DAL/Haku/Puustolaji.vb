...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Puustolaji.OrderBy(Function(x) x.PLAPuustolaji)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Puustolaji)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Puustolaji)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.PLAId
        hakutulos.Nimi = muunnettava.PLAPuustolaji
        hakutulos.Tyyppi = "Puustolaji"
        Return hakutulos
