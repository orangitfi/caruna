...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlps_Kuukausi
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlps_Kuukausi)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlps_Kuukausi)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.KUUId
        hakutulos.Nimi = muunnettava.KUUKuukausi
        hakutulos.Tyyppi = "Kuukausi"
        Return hakutulos
