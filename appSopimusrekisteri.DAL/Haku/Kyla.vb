...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Kyla.OrderBy(Function(x) x.KYLKyla)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Kyla)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Kyla)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.KYLId
        hakutulos.Nimi = muunnettava.KYLKyla
        hakutulos.Tyyppi = "Kylä"
        Return hakutulos
