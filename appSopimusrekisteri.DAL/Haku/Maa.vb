...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Maa.Where(Function(x) x.MAANimiSuomi <> String.Empty).OrderBy(Function(x) x.MAANimiSuomi)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Maa)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Maa)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.MAAId
        hakutulos.Nimi = muunnettava.MAANimiSuomi
        hakutulos.Tyyppi = "Maa"
        Return hakutulos
