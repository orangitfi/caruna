...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Indeksityyppi.OrderBy(Function(x) x.ITYIndeksityyppi)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Indeksityyppi)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Indeksityyppi)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.ITYId
        hakutulos.Nimi = muunnettava.ITYIndeksityyppi
        hakutulos.Tyyppi = "Indeksityyppi"
        Return hakutulos
