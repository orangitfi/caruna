...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Metsatyyppi.OrderBy(Function(x) x.MTYMetsatyyppi)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Metsatyyppi)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Metsatyyppi)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.MTYId
        hakutulos.Nimi = muunnettava.MTYMetsatyyppi
        hakutulos.Tyyppi = "Metsätyyppi"
        Return hakutulos
