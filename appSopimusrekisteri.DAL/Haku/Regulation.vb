...
#Region "Hakumetodit"
    ...
    Public Function HaeTulokset(hakuehdot As Expressions.Expression(Of Func(Of DataRow, Boolean))) As List(Of iHakutulos) Implements iHaettava.HaeTulokset
        ...
        Using tietokanta As New Entities.FortumEntities()
            ...
            Dim rivit = tietokanta.hlp_Regulation.OrderBy(Function(x) x.REGNimi)
...
#Region "Konversiometodit"
    ...
    Public Function MuutaHakutulokseksi(muunnettavat As IEnumerable(Of Tietotyyppi.hlp_Regulation)) As List(Of iHakutulos)
    ...
    Private Function MuutaHakutulokseksi(muunnettava As Tietotyyppi.hlp_Regulation)

        Dim hakutulos = New Hakutulos()
        hakutulos.ID = muunnettava.REGId
        hakutulos.Nimi = muunnettava.REGNimi
        hakutulos.Tyyppi = "Regulation"
        Return hakutulos
