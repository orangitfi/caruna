...
' Yritykset ovat osaotos Tahoista, joten tässä luokassa kutsutaan
...
#Region "Hakumetodit"
  ...
  Public Function HaeYritys(id As Integer) As Entities.Taho
...
#Region "Muokkausmetodit"
  ...
  Public Function LisaaYritys(taho As Entities.Taho) As Entities.Taho
  ...
  Public Function LisaaYritysSopimukselle(tahoId As Integer, sopimusId As Integer) As Entities.Sopimus_Taho
  ...
  Public Function MuokkaaYritysta(taho As Entities.Taho) As Entities.Taho
  ...
  Public Function PoistaYritys(tahoId As Integer) As Entities.Taho
